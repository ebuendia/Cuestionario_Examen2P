...
\title{CUESTIONARIO -  EJERCICIOS SEBESTA}
\author{ Erick Buendia, Adriana Rodriguez, Jose Luis Bueno}
...
\subfile{./tex/Capitulo5}
\subfile{./tex/Capitulo6}
\subfile{./tex/Capitulo7}
\subfile{./tex/Capitulo8}
\subfile{./tex/Capitulo9}
